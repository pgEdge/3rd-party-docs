...
{ "code": "PGRST205", "message": "Could not find the table 'public.itemsxx' in the schema cache", "details": "Perhaps you meant the table 'public.items'", "hint": null }
...
{ "code": "PGRST205", "message": "Could not find the table 'public.itemsxx' in the schema cache" }
