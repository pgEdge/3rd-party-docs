...
!!! note
 ...
 The PostGIS module is an extension to the PostgreSQL backend server. As such, PostGIS 3.5.7 *requires* full PostgreSQL server headers access in order to compile. It can be built against PostgreSQL versions 12 - 18. Earlier versions of PostgreSQL are *not* supported.
...
## Getting the Source
 ...
 Retrieve the PostGIS source archive from the downloads website [https://download.osgeo.org/postgis/source/postgis-3.5.7.tar.gz](https://download.osgeo.org/postgis/source/postgis-3.5.7.tar.gz)


```
wget https://download.osgeo.org/postgis/source/postgis-3.5.7.tar.gz
tar -xvzf postgis-3.5.7.tar.gz
cd postgis-3.5.7
```


 This will create a directory called `postgis-3.5.7` in the current working directory.
...
`--without-topology`
:   Disable topology support. There is no corresponding library as all logic needed for topology is in postgis-3.5.7 library.
...
------------------------------+-----------------+-------------------
 address_standardizer         | 3.5.7         | 3.5.7
 address_standardizer_data_us | 3.5.7         | 3.5.7
 postgis                      | 3.5.7         | 3.5.7
 postgis_raster               | 3.5.7         | 3.5.7
 postgis_sfcgal               | 3.5.7         |
 postgis_tiger_geocoder       | 3.5.7         | 3.5.7
