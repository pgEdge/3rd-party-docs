...
:   This clause replaces the foreign server or connection string originally set by [sql-createsubscription](create-subscription.md#sql-createsubscription) with the foreign server *server_name*.
