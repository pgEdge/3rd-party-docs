...
`fastupdate` (`boolean`)
:   This setting controls usage of the fast update technique described in [GIN Fast Update Technique](../../internals/built-in-index-access-methods/gin-indexes.md#gin-fast-update). It is a Boolean parameter: `ON` enables fast update, `OFF` disables it. The default is `ON`.
