...
`PARALLEL`
:   Specifies the maximum number of parallel workers that can be used for [Parallel Vacuum](../../server-administration/routine-database-maintenance-tasks/routine-vacuuming.md#parallel-vacuum), which is further limited by [max_parallel_maintenance_workers](../../server-administration/server-configuration/resource-consumption.md#guc-max-parallel-maintenance-workers). This option can't be used with the `FULL` option.
