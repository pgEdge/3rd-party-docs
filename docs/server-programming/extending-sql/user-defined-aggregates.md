...
### Moving-Aggregate Mode { #xaggr-moving-aggregates }
...
### Polymorphic and Variadic Aggregates { #xaggr-polymorphic-aggregates }
...
### Ordered-Set Aggregates { #xaggr-ordered-set-aggregates }
...
### Partial Aggregation { #xaggr-partial-aggregates }
...
### Support Functions for Aggregates { #xaggr-support-functions }
