...
```
 ...
 To call another version-1 function, you can use <code>DirectFunctionCall</code><em>n</em><code>(func,
     arg1, ..., argn)</code>. This is particularly useful when you want to call functions defined in the standard internal library, by using an interface similar to their SQL signature.
