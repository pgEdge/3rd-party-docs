...
## Operator Optimization Information
 ...
 Additional optimization clauses might be added in future versions of PostgreSQL. The ones described here are all the ones that release 19beta4 understands.
