## Synchronous Replication Support for Logical Decoding { #logicaldecoding-synchronous }


### Overview { #logicaldecoding-synchronous-overview }
...
### Caveats { #logicaldecoding-synchronous-caveats }
