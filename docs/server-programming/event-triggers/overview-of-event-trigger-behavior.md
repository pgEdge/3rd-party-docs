...
### ddl_command_start { #event-trigger-ddl_command_start }
...
### ddl_command_end { #event-trigger-ddl_command_end }
...
### sql_drop { #event-trigger-sql_drop }
...
### table_rewrite { #event-trigger-table_rewrite }
...
### Event Triggers in Aborted Transactions { #event-trigger-aborted-transactions }
...
### Creating Event Triggers { #event-trigger-creating }
