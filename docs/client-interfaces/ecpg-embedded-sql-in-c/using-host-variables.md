## Using Host Variables { #ecpg-variables }
...
### Overview { #ecpg-variables-overview }
...
### Declare Sections { #ecpg-declare-sections }
...
### Retrieving Query Results { #ecpg-retrieving }
...
### Type Mapping { #ecpg-variables-type-mapping }
...
| `decimal` | `decimal` (This type can only be accessed through special library functions; see [Accessing Special Data Types](#ecpg-special-types).) |
...
#### Handling Character Strings { #ecpg-char }
...
#### Accessing Special Data Types { #ecpg-special-types }
...
##### timestamp, date { #ecpg-special-types-timestamp-date }
...
##### numeric, decimal { #ecpg-type-numeric-decimal }
...
##### bytea { #ecpg-special-types-bytea }
...
#### Host Variables with Nonprimitive Types { #ecpg-variables-nonprimitive-c }


 As a host variable you can also use arrays, typedefs, structs, and pointers.


##### Arrays { #ecpg-variables-arrays }
...
##### Structures { #ecpg-variables-struct }
...
##### Typedefs { #ecpg-variables-nonprimitive-c-typedefs }
...
##### Pointers { #ecpg-variables-nonprimitive-c-pointers }
...
### Handling Nonprimitive SQL Data Types { #ecpg-variables-nonprimitive-sql }
...
#### Arrays { #ecpg-variables-nonprimitive-sql-arrays }
...
#### Composite Types { #ecpg-variables-nonprimitive-sql-composite }
...
#### User-Defined Base Types { #ecpg-variables-nonprimitive-sql-user-defined-base-types }
