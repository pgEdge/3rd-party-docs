## basebackup_to_shell — example "shell" pg_basebackup module { #basebackup-to-shell }
...
### Configuration Parameters { #basebackup-to-shell-configuration-parameters }
...
### Author { #basebackup-to-shell-author }
