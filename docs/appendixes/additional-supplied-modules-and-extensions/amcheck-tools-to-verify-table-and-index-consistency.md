## amcheck — tools to verify table and index consistency { #amcheck }
...
### Optional `heapallindexed` Verification { #amcheck-optional-heapallindexed-verification }
...
### Using `amcheck` Effectively { #amcheck-using-amcheck-effectively }
...
### Repairing Corruption { #amcheck-repairing-corruption }
