...
!!! note
    ...
    Additional information about GDAL_DATA is available at GDAL's [Configuration Options](https://gdal.org/user/configoptions.html).
...
!!! note
    ...
    Additional information about GDAL_SKIP is available at GDAL's [Configuration Options](https://gdal.org/user/configoptions.html).
...
## Description
 ...
 A string configuration to set options used when working with an out-db raster. [Configuration options](https://gdal.org/user/configoptions.html) control things like how much space GDAL allocates to local data cache, whether to read overviews, and what access keys to use for remote out-db data sources.
