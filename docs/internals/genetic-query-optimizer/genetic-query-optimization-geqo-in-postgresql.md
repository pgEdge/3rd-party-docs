## Genetic Query Optimization (GEQO) in PostgreSQL { #geqo-pg-intro }
...
### Generating Possible Plans with GEQO { #geqo-pg-intro-gen-possible-plans }
...
### Future Implementation Tasks for PostgreSQL GEQO { #geqo-future }
