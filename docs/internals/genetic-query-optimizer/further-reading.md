...
-  [Fundamentals of Database Systems](../../.#elma04)
-  [[The design and implementation of the POSTGRES query optimizer](https://dsf.berkeley.edu/papers/UCB-MS-zfong.pdf)](../../.#fong)
