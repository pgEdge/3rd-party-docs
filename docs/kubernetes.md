...
Patroni Kubernetes [settings](patroni-configuration/yaml_configuration.md#kubernetes_settings) and [environment variables](patroni-configuration/ENVIRONMENT.md#kubernetes_environment) are described in the general chapters of the documentation.
...
- The [kubernetes](https://github.com/patroni/patroni/tree/master/kubernetes) folder of the Patroni repository contains
...
- You can find the full-featured Docker image that can use Persistent Volumes in the
    [Spilo Project](https://github.com/zalando/spilo).

- There is also a [Helm chart](https://github.com/kubernetes/charts/tree/master/incubator/patroni)
...
- In order to run your database clusters at scale using Patroni and Spilo, take a look at the
    [postgres-operator](https://github.com/zalando/postgres-operator) project. It implements the operator pattern
