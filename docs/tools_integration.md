...
The `recover` sub-command can be used as a custom bootstrap or custom replica creation method. You can find more information about that in [Replica imaging and bootstrap](replica_bootstrap.md#replica_imaging_and_bootstrap).
