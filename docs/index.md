...
pgBackRest [v2.59.0](https://github.com/pgbackrest/pgbackrest/releases/tag/release/2.59.0) is the current stable release. Release notes are on the [Releases](release.md) page.
...
Our sponsors:
 ...
 AWS Supabase pgEdge Tiger Data Percona Eon Xata Dalibo Data Egret 
...
Our [sponsors](index.md#sponsors) offer products and services that include pgBackRest support and can help with your disaster recovery needs.
