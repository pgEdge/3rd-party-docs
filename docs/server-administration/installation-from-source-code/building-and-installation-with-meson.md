...
:   Build with support for LLVM based JIT compilation (see [Just-in-Time Compilation (JIT)](../just-in-time-compilation-jit/index.md#jit)). This requires the LLVM library to be installed. The minimum required version of LLVM is currently 10. Disabled by default.
