## Extensibility { #jit-extensibility }


### Inlining Support for Extensions { #jit-extensibility-bitcode }
...
### Pluggable JIT Providers { #jit-pluggable }
...
#### JIT Provider Interface { #jit-pluggable-provider-interface }
