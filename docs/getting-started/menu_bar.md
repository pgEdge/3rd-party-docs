...
| *Runtime* | Click to open a submenu to Configure, View Log and Zoom settings. Only visible when pgAdmin4 runs in desktop mode. To know more about runtime menu [click here](deployment/desktop_deployment.md#desktop_deployment) |
