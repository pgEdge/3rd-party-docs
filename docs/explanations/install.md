...
# Set environment variable GHCRTS set to "-N2" docker run --rm -p 3000:3000  -e PGRST_DB_URI="postgres://app_user:password@10.0.0.10/postgres"  -e GHCRTS="-N2" postgrest/postgrest
<a id="build_source"></a>
