...
To work with [PostGIS](https://postgis.net/) data types such as `geometry` or `geography`, you'll need to [install PostGIS](https://postgis.net/documentation/getting_started/) first.
...
```
<a id="application/geo+json"></a>

## application/geo+json

PostgREST supports the [standard](https://www.iana.org/assignments/media-types/application/geo+json) `application/geo+json` media type which can be used to get the output in [GeoJSON](https://geojson.org/) format. This will work for PostGIS versions 3.0.0 and up and will return the output as a [FeatureCollection Object](https://www.rfc-editor.org/rfc/rfc7946#section-3.3):
