...
A composite type used as input into the [RT_ST_Reclass](raster-processing-map-algebra.md#RT_ST_Reclass) function defining the behavior of reclassification.
