...
## Directory containing many files
 ...
 To control this behavior, GDAL provides the following environment variable: [GDAL_DISABLE_READDIR_ON_OPEN](https://gdal.org/user/configoptions.html#config-GDAL_DISABLE_READDIR_ON_OPEN). Set `GDAL_DISABLE_READDIR_ON_OPEN` to `TRUE` to disable directory scanning.
