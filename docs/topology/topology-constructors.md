...
The `srid` is the [spatial reference system](../data-management/spatial-reference-systems.md#spatial_ref_sys) SRID for the topology. The SRID defaults to -1 (unknown) if not specified.
