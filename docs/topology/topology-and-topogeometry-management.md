...
[AddTopoGeometryColumn](#AddTopoGeometryColumn)
  <a id="FixCorruptTopoGeometryColumn"></a>
...
[ValidateTopology](#ValidateTopology)
  <a id="ValidateTopologyPrecision"></a>
...
## See Also
 ...
 [MakeTopologyPrecise](#MakeTopologyPrecise)
  <a id="MakeTopologyPrecise"></a>
...
!!! note
    ...
    Snapping could make the topology invalid, so it is recommended to check the outcome of operation with [ValidateTopology](#ValidateTopology).
...
## See Also
 ...
 [ValidateTopologyPrecision](#ValidateTopologyPrecision), [ValidateTopology](#ValidateTopology)
  <a id="FindTopology"></a>
