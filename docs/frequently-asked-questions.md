...
You can use [half-precision vectors](half-precision-vectors.md) or [half-precision indexing](half-precision-indexing.md) to index up to 4,000 dimensions or [binary quantization](binary-quantization.md) to index up to 64,000 dimensions. Other options are [indexing subvectors](indexing-subvectors.md) (for models that support it) or [dimensionality reduction](https://en.wikipedia.org/wiki/Dimensionality_reduction).
